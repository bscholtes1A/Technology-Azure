...
import static org.eclipse.edc.test.system.Constants.POLL_INTERVAL;
import static org.eclipse.edc.test.system.Constants.TIMEOUT;
...
public class TransferTestClient {
    ...
    public JsonArray getCatalogDatasets(String providerUrl) {
        ...
        Awaitility.await().atMost(TIMEOUT).pollInterval(POLL_INTERVAL).untilAsserted(() -> {
